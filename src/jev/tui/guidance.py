...
from jev.core.guidance import GLOSSARY, WELCOME, Explanation
...
class TourScreen(WorkbenchScreen):
    ...
    def compose(self) -> ComposeResult:
        yield Header()
        with VerticalScroll(classes="page"):
            yield Static("Welcome to jev", classes="eyebrow")
    ...
    def show_step(self) -> None:
        copy = (
            ...
            "You can run this tour again with jev tour. Choose Finish to open your saved designs.",
        )
        ...
        try:
            ...
            message = human_error(
                JevError(
                    ...
                    "Check permissions for your jev data folder. Ctrl+Q can still close the app.",
                )
            )
