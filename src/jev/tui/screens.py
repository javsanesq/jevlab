...
from jev.tui.dialogs import Confirm, Prompt, state_file
from jev.tui.editor import TemplateEditor
from jev.tui.fields import Field, identifier, numeric
...
class Home(WorkbenchScreen):
    ...
    def compose(self) -> ComposeResult:
        ...
        with VerticalScroll(classes="page"):
            yield Static("JEV / WORKBENCH", classes="eyebrow")
    ...
    def pressed(self, event: Button.Pressed) -> None:
        ...
        if button == "playground":
            ...
            from jev.tui.guidance import DemoScreen, TourScreen

            self.app.push_screen(TourScreen(self.wb) if button == "tour" else DemoScreen(self.wb))
        elif button in ("learn", "library", "coach"):
            from jev.tui.learning import CoachScreen, LearnScreen, LibraryScreen
    ...
    async def action_run(self) -> None:
        ...
        try:
            ...
            error = JevError(
                ...
                "Run jev doctor. Check history before retrying: "
            ...
            try:
                ...
                self.report_error(
                    JevError(
                        ...
                        "Refresh past results or run jev doctor to check local storage.",
                    )
                )
        ...
        with VerticalScroll(classes="page"):
            ...
            with Vertical(classes="advanced settings-advanced"):
                ...
                yield Static(
                    ...
                    "key and optional software package. Run jev doctor --coach in your terminal "
                    "to check both.",
                    classes="muted",
                )
    ...
    async def run_doctor(self) -> None:
        ...
        try:
            ...
            error = JevError(
                ...
                "Run jev doctor in your terminal and check that the app's data folder is readable.",
            )
