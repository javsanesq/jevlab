...
from jev.coach.errors import coach_error
from jev.coach.service import Coach, CoachResult
from jev.core.content import (
    Lesson,
    Pattern,
    export_dataset,
    lesson,
...
from jev.tui.dialogs import Confirm, Prompt
from jev.tui.editor import TemplateEditor
from jev.tui.fields import Field, identifier, output_file, required
from jev.tui.screens import Playground, RawScreen, ResultScreen, SettingsScreen
from jev.tui.spending import confirm_spend, flow_error
    ...
    def compose(self) -> ComposeResult:
        ...
        with VerticalScroll(classes="page"):
            ...
            if report.evaluation:
                from jev.tui.evaluation import calibration_plot
    ...
    def validate_target(self, value: str) -> str | None:
        ...
        try:
            ...
            return (
                ...
                "Run jev doctor to check local storage."
            )
        return None
