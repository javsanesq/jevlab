...
from jev.tui.dialogs import Help
...
from jev.tui.screens import History, Home, Playground, SettingsScreen
...
class JevApp(App[None]):
    ...
    def on_mount(self) -> None:
        from jev.tui.guidance import DemoScreen, Glossary, TourScreen
    ...
    def action_explain(self) -> None:
        from jev.core.guidance import CONTROL_GUIDANCE, Explanation, explain_control
    ...
    def action_glossary(self) -> None:
        from jev.tui.guidance import Glossary
    ...
    def _handle_exception(self, error: Exception) -> None:
        ...
        safe = (
            ...
            if isinstance(error, JevError)
                ...
                "Start jev again and run jev doctor. "
