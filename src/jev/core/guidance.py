...
GLOSSARY: dict[str, str] = {
    ...
    "API key": (
        ...
        "only in the password field; jev saves it in macOS Keychain, not in your templates."
    ),
    "Keychain": (
        "The password storage built into macOS. For example, jev can retrieve your saved "
...
_controls(
    ...
    "text you enter so jev can read it.",
    "JSON",
)
_controls(
...
_controls(
    "run-jev job-run grade-lesson compare-run",
...
_controls(
    ...
    "and dependencies. For a live coach check, run jev doctor --coach in the terminal "
...
_controls(
    ...
    "return later with jev tour. Escape returns to the previous screen.",
)
_controls(
...
_controls(
    ...
    "jev; a path identifies a file on your computer. Enter accepts and Escape cancels.",
)
_controls(
    "close-error",
...
def explain_answer(run: Run, question_name: str) -> str:
    ...
    return text + " This is a recommendation; jev has not sent or changed anything."
