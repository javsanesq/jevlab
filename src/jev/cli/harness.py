        ...
        if json_output:
            ...
            console.print(
                Text(
                    ...
                    "Requires your separate JEV_SERVER_TOKEN. Ctrl+C stops the server."
                )
            )
