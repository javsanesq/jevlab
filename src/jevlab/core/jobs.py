...
from jevlab.core.datasets import DatasetInfo, DatasetRow, inspect_dataset, iter_dataset
        ...
        with _job_lock(self.wb.root, report.id):
            ...
            try:
                ...
                report.error = JevError(
                    ...
                    "Inspect the saved job details and run jevlab doctor before resuming. "
