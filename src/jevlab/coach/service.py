...
from jevlab.coach.errors import coach_error, redact_json_text, sanitize_text
from jevlab.core.client import suppress_wire_logs
from jevlab.core.content import Lesson
from jevlab.core.credentials import ENV_KEYS, Credentials, Provider, resolve_credentials
from jevlab.core.errors import JevError
from jevlab.core.learning import GradeReport
from jevlab.core.models import Run, Settings, StrictModel, Template
    ...
    async def ask(
        ...
        if config.coach_provider == "disabled" or not config.coach_model_for().strip():
            raise JevError(
                ...
                "Use Settings or jevlab config --set coach_provider=… --set coach_model=….",
                3,
            )
