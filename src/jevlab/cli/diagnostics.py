...
from jevlab.cli.common import console, emit, stderr, verbose_errors
from jevlab.coach.diagnostics import check_coaches, probe_estimates
        ...
        if not yes:
            if machine or not sys.stdin.isatty():
                raise JevError(
                    ...
                    "Use jevlab doctor --coach --offline --json to inspect estimates, then add "
